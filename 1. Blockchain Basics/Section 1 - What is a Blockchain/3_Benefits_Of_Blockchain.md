...
Together, these features ensure that the system is both predictable and trustworthy. You don't have to trust a person or a company to act honorably; you only have to trust the code, which operates exacctly as it is written for all to see.